...
public class TrelloFacadeTest {
    ...
    void shouldCreateCard() {
        ...
        CreatedTrelloCardDto createdTrelloCardDto = new CreatedTrelloCardDto("1",badgesDto,"nameCard","shortUrl");
        ...
        assertThat(createdTrelloCardDto1.getBadges().getAttachmentsByType().getTrello().getBoard()).isEqualTo(1);
        assertThat(createdTrelloCardDto1.getBadges().getAttachmentsByType().getTrello().getCard()).isEqualTo(1);
